...
public class ColorUtils {
     ...
     */
   static private ArrayList<ColorName> initColorList() {
     ...
     * @return
     */
   static public String getColorNameFromRgb(int r, int g, int b) {
   ...
   static public String getColorNameFromColor(Color color) {
        return getColorNameFromRgb(((int) color.getRed()*255),(int)(  color.getGreen()*255),
